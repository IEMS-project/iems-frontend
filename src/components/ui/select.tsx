...
// Default native Select wrapper for places that use a simple <select> element.
...
export default function NativeSelect({ label, error, className = "", children, ...props }: NativeSelectProps) {
