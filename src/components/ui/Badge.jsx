...
const variants = {
  black: "bg-white text-black ring-black dark:bg-gray-900 dark:text-white dark:ring-gray-300/10",
  ...
  success: "bg-green-100 text-green-700 ring-green-200 dark:bg-green-900/40 dark:text-green-200 dark:ring-green-800",
